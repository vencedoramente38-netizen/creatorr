    ...
    <div className="space-y-8 pb-20">
      ...
      <div className="p-8 rounded-3xl bg-[#09090B]/50 border border-dashed border-zinc-800 flex flex-col items-center text-center space-y-4">
        ...
        <div>
          ...
          <p className="text-sm text-zinc-500 max-w-xs">Use o Creatoria para criar novos roteiros otimizados para viralizar no TikTok.</p>
        </div>
        <button className="px-6 py-2 bg-primary text-white font-bold rounded-full text-sm">Ir para Creatoria</button>
      </div>
    </div>
  );
};
